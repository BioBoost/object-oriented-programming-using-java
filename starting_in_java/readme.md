...
The next chapters will take a look at all these building blocks. However before this is discussed in detail we will take a look at a simple program that every programmer should create in every language he/she ever learns.
